...
def Sidebar():
    with st.sidebar:
        ...
        # Section Selector
        selection = st.selectbox("Select Section", ["Home Page", "Regulations & Settings", "Season 1", "Season 2", "Season 3", "Season 4", "All Time Driver Statistics", "All Time Constructor Statistics", "All Time Race Results"])
