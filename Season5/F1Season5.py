...
from Season5.Tab0_LeagueNews import Tab0
from Season5.Tab1_Standings import Tab1
from Season5.Tab2_RaceResults import Tab2
from Season5.Tab3_ConstructorStatistics import Tab3
from Season5.Tab4_DriverStatistics import Tab4
from Season5.Tab5_DriverComparison import Tab5
from Season5.Tab6_RaceSchedule import Tab6
from Season5.Calculations import Calculations
...
def Season5():
    ...
    # Header
    logo = Image.open("./Season5/Images/TheAlternativeLogoS5.png")
    st.image(logo)
