...
def HomePageRegulations():
    rules = {
        ...
        "Definition":   [
                            ...
                            'If a driver wrongfully receives a Drive Through Penalty due to a VSC or Safety Car delta glitch, the driver will have their finsihing time improved by 20 seconds. This remedy will only be applied upon driver request and review by the FIA, if no Safety Car or Red Flag occurs after the glitch occurred.',
