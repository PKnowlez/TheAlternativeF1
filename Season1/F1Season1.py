...
from Season1.Tab0_LeagueNews import Tab0
from Season1.Tab1_Standings import Tab1
from Season1.Tab2_RaceResults import Tab2
from Season1.Tab3_ConstructorStatistics import Tab3
from Season1.Tab4_DriverStatistics import Tab4
from Season1.Tab5_DriverComparison import Tab5
from Season1.Tab6_RaceSchedule import Tab6
from Season1.Calculations import CalculationFunction
...
def Season1():
    ...
    # Header
    logo = Image.open("./Season1/Images/TheAlternativeLogo.png")
    st.image(logo)
