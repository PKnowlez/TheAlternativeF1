...
tracks_1 = Image.open('./Season4/Images/Tracks_1.png')
tracks_2 = Image.open('./Season4/Images/Tracks_2.png')
tracks_3 = Image.open('./Season4/Images/Tracks_3.png')
tracks_4 = Image.open('./Season4/Images/Tracks_4.png')
tracks_5 = Image.open('./Season4/Images/Tracks_5.png')
tracks_6 = Image.open('./Season4/Images/Tracks_6.png')
miami = Image.open('./Season4/Images/track_reveal_miami.png')
surfer_gif = open('./Season4/Images/surfer.gif','rb')
contents = surfer_gif.read()
data_url_surfer = base64.b64encode(contents).decode('utf-8')
no_mikey = Image.open('./Season4/Images/no_mikey.png')
